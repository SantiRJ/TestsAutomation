...
public class TestDespegar {
	...
	public void ValidarBusquedaDespegar() throws Exception {
		...
		//falta clickear en el boton de salida
		...
		cantNiños.click();	
		WebElement menores = driver.findElement(By.cssSelector(".stepper_room .stepperroom_row:nth-child(3) .select-container"));
		menores.click();
		System.out.println("Clickeando edad minima");
		WebElement edadmin = menores.findElement(By.cssSelector(".select-option[value='4']"));
		edadmin.click();
		Thread.sleep(2000);
		WebElement aplicar = driver.findElement(By.cssSelector("div.sbox5-floating-tooltip-opened div.stepper_room_footer>a:nth-child(1)"));
		aplicar.click();
